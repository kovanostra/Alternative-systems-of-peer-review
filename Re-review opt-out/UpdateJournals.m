function [ scientists, journals, journalsToUpdate, reviewerSpentTime, reviewsCounter ] = ...
         UpdateJournals( scientists, journals, journalsToUpdate, reviewerSpentTime, reviewsCounter )
