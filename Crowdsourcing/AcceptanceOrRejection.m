...
helpCommenters = rand(length(initialScientificInformation),1);
reviewersOnlineTemp = round(initialScientificInformation.*(1./meanSI)^2);
...
[ scientists, qualityEvaluated(firstRound == 1) ] = Evaluation( scientists, journal(firstRound == 1), finalQuality(firstRound == 1),...
    reviewersOnlineTemp(firstRound == 1) );
...
[ scientists, qualityEvaluated(secondRound == 1) ] = Evaluation( scientists, journal(secondRound == 1), ...
    papers.improvedQuality(secondRound == 1)', reviewersOnlineTemp(secondRound == 1) );
